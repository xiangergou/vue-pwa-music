...
/* harmony default export */ var Detail = (create({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', [_c('field', _vm._g({ ref: "field", attrs: { "rows": "1", "autosize": "", "type": "textarea", "maxlength": "200", "value": _vm.value, "error": _vm.error, "label": _vm.$t('label'), "placeholder": _vm.$t('placeholder') }, on: { "click-icon": _vm.onClickIcon } }, _vm.$listeners), [_c('div', { attrs: { "slot": "icon" }, slot: "icon" }, [_vm.showIcon && _vm.isAndroid ? _c('span', { class: _vm.b('finish') }, [_vm._v(_vm._s(_vm.$t('complete')))]) : _vm.showIcon ? _c('icon', { attrs: { "name": "clear" } }) : _vm._e()], 1)]), _vm._l(_vm.searchResult, function (express) {
